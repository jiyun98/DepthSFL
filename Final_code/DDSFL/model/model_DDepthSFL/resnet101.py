...
class ResNet101_server_v1(nn.Module):  # Dropout (or pruned) ResNet [width] 
    def __init__(self, block, num_blocks, num_classes=10):
    ...
    def forward(self, x):
        ...
        out3_2 = self.layer3[1:11](out3)
        out = self.layer3[11:](out3_2)
        out = self.layer4(out)
...
class ResNet101_server_v2(nn.Module):  # Dropout (or pruned) ResNet101 [width] 
    ...
    def forward(self, x):
        out3 = self.layer3[0:10](x)
        out3_2 = self.layer3[10:](out3)
...
# ---------------------------------------------------
class ResNet101_client_v3(nn.Module):  # Dropout (or pruned) ResNet101 [width] 
    def __init__(self, block, num_blocks,  num_classes=10):
        super(ResNet101_client_v3, self).__init__()
        self.in_planes = 64
    ...
    def forward(self, x):
        ...
        return [out0, out3, out3_2]
    

class ResNet101_server_v3(nn.Module):  # Dropout (or pruned) ResNet101 [width] 
    def __init__(self, block, num_blocks,  num_classes=10):
        super(ResNet101_server_v3, self).__init__()
        self.in_planes = 1024
