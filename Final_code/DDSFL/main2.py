...
if __name__ == '__main__':
    ...
    if args.wandb:
        run  = wandb.init(dir = filename, project = 'Proposed(0926)',
    ...
    if args.method == 'dsfl':  
        ...
        main_DDepthSFL(args)
        if args.kd_gkt_opt:
            args.method = 'gkt_ddsfl'
            with open('./logs/learning_log.txt', 'a+') as f: # selected idx로 global model size 설정
                f.write("[Method:{}], [Data:{}], [Model:{}], [Cutpoint:{}], [KD_epoch:{}], [Lambdaa:{}], [T:{}], [Seed:{}], [Epoch:{}], [BatchSize:{}], [Frac:{}], [Time:{}]\n".format(
                            args.method, args.data, args.model_name, args.cut_point, args.kd_epoch, args.lambdaa, args.T,
                            args.seed, args.epochs, args.bs, args.frac, timestamp))
        else:
            with open('./logs/learning_log.txt', 'a+') as f: # selected idx로 global model size 설정
                f.write("[Method:{}], [Data:{}], [Model:{}], [Cutpoint:{}], [Seed:{}], [Epoch:{}], [BatchSize:{}], [Frac:{}], [Time:{}]\n".format(
