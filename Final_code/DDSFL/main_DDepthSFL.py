...
from train.train_DDepthSFL import *
...
def main_DDepthSFL(args):
    ...
    local_cmodels, local_smodels, auxiliary_models, args.cut_point = model_assignment(args.model_name, args.num_classes, args.device)
    ...
    for iter in range(1,args.epochs+1):
        ...
        if args.learnable_step:
            if iter == args.epochs/2:
                ...
                args.lr_server = args.lr_server * 0.1
        kd_gkt_opt = False
        if iter >= args.kd_epoch and args.kd_gkt_opt:
            kd_gkt_opt = True
