...
#                split & pruned resnet
# ---------------------------------------------------
class ResNet18_SFL_client_v1(nn.Module):  # Dropout (or pruned) ResNet [width] 
    def __init__(self, block, num_blocks, num_classes=10):
        super(ResNet18_SFL_client_v1, self).__init__()
        self.in_planes = 64
...
class ResNet18_SFL_server_v1(nn.Module):  # Dropout (or pruned) ResNet [width] 
    def __init__(self, block, num_blocks, num_classes=10):
        super(ResNet18_SFL_server_v1, self).__init__()
        self.in_planes = 64
...
#                split & pruned resnet v4
# ---------------------------------------------------
class ResNet18_SFL_client_v2(nn.Module):  # Dropout (or pruned) ResNet [width] 
    def __init__(self, block, num_blocks,  num_classes=10):
        super(ResNet18_SFL_client_v2, self).__init__()
        self.in_planes = 64
...
class ResNet18_SFL_server_v2(nn.Module):  # Dropout (or pruned) ResNet [width] 
    def __init__(self, block, num_blocks,  num_classes=10):
        super(ResNet18_SFL_server_v2, self).__init__()
        self.in_planes = 64
...
# ---------------------------------------------------
class ResNet18_SFL_client_v3(nn.Module):  # Dropout (or pruned) ResNet [width] 
    def __init__(self, block, num_blocks,  num_classes=10):
        super(ResNet18_SFL_client_v3, self).__init__()
        self.in_planes = 64
...
class ResNet18_SFL_server_v3(nn.Module):  # Dropout (or pruned) ResNet [width] 
    def __init__(self, block, num_blocks,  num_classes=10):
        super(ResNet18_SFL_server_v3, self).__init__()
        self.in_planes = 128
