...
#                split & pruned resnet
# ---------------------------------------------------
class ResNet34_SFL_client_v1(nn.Module):  # Dropout (or pruned) ResNet [width] 
    def __init__(self, block, num_blocks, num_classes=10):
        super(ResNet34_SFL_client_v1, self).__init__()
        self.in_planes = 64
...
class ResNet34_SFL_server_v1(nn.Module):  # Dropout (or pruned) ResNet [width] 
    def __init__(self, block, num_blocks, num_classes=10):
        super(ResNet34_SFL_server_v1, self).__init__()
        self.in_planes = 64
...
# ---------------------------------------------------
class ResNet34_SFL_client_v2(nn.Module):  # Dropout (or pruned) ResNet [width] 
    def __init__(self, block, num_blocks,  num_classes=10):
        super(ResNet34_SFL_client_v2, self).__init__()
        self.in_planes = 64
...
class ResNet34_SFL_server_v2(nn.Module):  # Dropout (or pruned) ResNet34 [width] 
    def __init__(self, block, num_blocks,  num_classes=10):
        super(ResNet34_SFL_server_v2, self).__init__()
        self.in_planes = 128
...
# ---------------------------------------------------
class ResNet34_SFL_client_v3(nn.Module):  # Dropout (or pruned) ResNet34 [width] 
    def __init__(self, block, num_blocks,  num_classes=10):
        super(ResNet34_SFL_client_v3, self).__init__()
        self.in_planes = 64
...
class ResNet34_SFL_server_v3(nn.Module):  # Dropout (or pruned) ResNet34 [width] 
    def __init__(self, block, num_blocks,  num_classes=10):
        super(ResNet34_SFL_server_v3, self).__init__()
        self.in_planes = 256
