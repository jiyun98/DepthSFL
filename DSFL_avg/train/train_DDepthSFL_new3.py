...
class LocalUpdate_client(object):
    ...
    def train(self, net_client, net_ax, kd_server_opt = None, kd_logits = None):
        ...
        if self.args.optimizer == 'sgd':
            ...
            optimizer_client = torch.optim.Adam(params, lr = self.args.lr, weight_decay=self.args.weight_decay)
...
class LocalUpdate_server(object):
    ...
    def train(self, net, net_ax):
        ...
        if self.args.optimizer == 'sgd':
            ...
            optimizer_server = torch.optim.Adam(params, lr = self.args.lr, weight_decay=self.args.weight_decay)
        ...
        for iter in range(self.args.local_ep):
            ...
            for j in range(len(self.data)):
                ...
                kd_loss = 0
                if self.args.kd_self_opt and len(S_logits)>1:
