...
from main_DDepthSFL_new3 import *
...
if __name__ == '__main__':
    ...
    filename = './output_avg3/{}/'.format(args.method_name) + args.name
    wandb_name = wandb_name + '[avg1]'
    if not os.path.exists(filename):
        os.makedirs(filename)

    if args.wandb:
        run  = wandb.init(dir = filename, project = 'Proposed_avg',
