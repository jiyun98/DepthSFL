...
from train.train_DDepthSFL_new import *
...
def main_DDepthSFL(args):      
    ...
    file_name_c = './output_new/{}/'.format(args.method_name) + args.name + '/[client]test_accuracy.txt'
    file_name_s = './output_new/{}/'.format(args.method_name) + args.name + '/[server]test_accuracy.txt'
