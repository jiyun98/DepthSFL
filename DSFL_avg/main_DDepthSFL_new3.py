...
def main_DDepthSFL(args):      
    ...
    for iter in range(1,args.epochs+1):
        ...
        for idx in idxs_users:
            ...
            weight_s, _, args, loss_s, acc_s = local_s.train(
    ...
    file_name_c = './output_avg3/{}/'.format(args.method_name) + args.name + '/[client]test_accuracy.txt'
    file_name_s = './output_avg3/{}/'.format(args.method_name) + args.name + '/[server]test_accuracy.txt'
