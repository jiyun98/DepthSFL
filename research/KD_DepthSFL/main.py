...
if __name__ == '__main__':
    ...
    # wandb setting
    wandb.init(project = '[New]KD-DepthSFL')
    ...
    program = '{}_{}_on_{}_with_{}_users_{}_epochs_seed_{}_split_{}.txt'.format(\
        'KD_DepthSFL',args.model_name, args.data, args.num_users, args.epochs, args.seed, args.cut_point)
    print(program)
    ...
    file_name_c = './saved/results/{}/client_{}_{}_on_{}_with_{}_users_split_point_{}_epochs_{}_seed_{}.txt'.format(
        args.model_name,'KD_DepthSFL', args.model_name, args.data, args.num_users, args.cut_point,args.epochs, args.seed)
    ...
    torch.save(net_glob_client.state_dict(), "./saved/saved_model/{}/client/client_{}_{}_on_{}_with_{}_users_split_point_{}_epochs_{}_seed_{}.pth".format(
        args.model_name,'KD_DepthSFL', args.model_name, args.data, args.num_users, args.cut_point,args.ps, args.epochs, args.seed))
    ...
    for i in range(args.num_models):
        torch.save(net_glob_server.state_dict(), "./saved/saved_model/{}/auxnet/{}_{}_auxnet_{}_{}_on_{}_with_{}_users_split_point_{}_epochs_{}_seed_{}.pth".format(
            args.model_name,'KD_DepthSFL', args.fr, args.cut_point[i], args.model_name, args.data, args.num_users, args.cut_point,args.ps, args.epochs, args.seed))
