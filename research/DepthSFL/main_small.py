...
if __name__ == '__main__':
    ...
    # wandb setting
    wandb.init(project = '[Small]DepthSFL')
    ...
    program = '{}_{}_on_{}_with_{}_users_{}_epochs_seed_{}_split_{}.txt'.format(\
        'DepthSFL',args.model_name, args.data, args.num_users, args.epochs, args.seed, args.cut_point)
    print(program)
    ...
    for iter in range(1,args.epochs+1):
        ...
        for idx in idxs_users:
            ...
            # Get according auxiliary network
            ax_model_select = auxiliary_models[model_idx]
            ...
            weight_c, weight_a, weight_s, args, loss_acc_c, loss_acc_s = local.train(
                net_client = copy.deepcopy(c_model_select), net_ax = copy.deepcopy(ax_model_select), net_server = copy.deepcopy(s_model_select))

            w_locals_c.append([copy.deepcopy(weight_c), model_idx])
            w_locals_s.append([copy.deepcopy(weight_s), model_idx])
            w_locals_a[model_idx].append(weight_a)
