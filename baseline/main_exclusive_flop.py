...
def main_exclusive(args):
    ...
    net_glob, args.cut_point = FL_model_assignment(args.model_v, args.selected_idx, args.model_name, args.device, args.num_classes)
    ...
    for iter in range(1, args.epochs+1):
        ...
        if iter % 10 == 0 :
            ...
            print('[Test][User {} with split point {}] [Loss  {:.3f} | Acc {:.3f}]'
                  .format(iter, idx, model_idx, test_loss, test_acc)) # 
