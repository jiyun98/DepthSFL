...
def main_reduction(args):
    ...
    net_glob, _ = FL_model_assignment(args.model_v, args.selected_idx, args.model_name, args.device, args.num_classes)
...
#     
    ...
    file_name = './output2/RED/' + args.name + '/test_accuracy.txt'
