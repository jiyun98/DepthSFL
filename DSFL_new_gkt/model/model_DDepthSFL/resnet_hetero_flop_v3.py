...
from model.model_DDepthSFL.resnet18_flop_v3 import *
...
'''resnet18'''
def resnet18_client_v3(num_classes = 10, cut_point = 1):
    if cut_point == 1:
       ...
       model = ResNet18_client_v4(block = BasicBlock, num_blocks = [2,2,2,2], num_classes = num_classes)
    return model

def resnet18_server_v3(num_classes = 10, cut_point = 1):
    if cut_point == 1:
        ...
        model = ResNet18_server_v4(block = BasicBlock, num_blocks = [2,2,2,2], num_classes = num_classes)   
    return model
